...
def main():
    base_path = "/home/julius/LargeThesisCode/headsResults"
    scaling_params = ["num_heads_2", "num_heads_4", "num_heads_6"]
    ...
    for eval_type in eval_types:
        default_file = os.path.join(base_path, f"num_heads_8_{eval_type}.csv")
