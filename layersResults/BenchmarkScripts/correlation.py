...
def main():
    base_path = "/home/julius/LargeThesisCode/layersResults"
    scaling_params = ["num_layers_2", "num_layers_4"]
    ...
    for eval_type in eval_types:
        default_file = os.path.join(base_path, f"num_layers_6_{eval_type}.csv")
